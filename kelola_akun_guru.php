...
$query = "SELECT*FROM login_guru where NIk ='$username'";
...
<body style="background-image: linear-gradient(#ffffff,#294A70);">
  ...
  <div class="container p-5">
    <div class="container p-5 py-5 bg-light rounded-5">
      <form action="simpan.php" method="POST" role="form">
        <div class="mb-3">
          <label for="exampleInputEmail1" class="form-label">NIK</label>
          <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="<?php $tr = mysqli_fetch_assoc($rows);
                                                                                                                    echo $tr["NIK"]; ?>" readonly>
          <div id="emailHelp" class="form-text">NIK tidak dapat diubah !!</div>
        </div>
        <div class="mb-3">
          <label for="exampleInputPassword1" class="form-label">Password</label>
          <input type="text" class="form-control" id="xpassword" name="xpassword" value="<?php echo $tr["password"] ?>">
        </div>
