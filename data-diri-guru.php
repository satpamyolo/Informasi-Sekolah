...
// Koneksi User Login
$username=$_SESSION['userGuru'];
$query ="SELECT*FROM guru where NIK ='$username'";
...
<body>
    ...
    <div class="container p-3 my-3" style="border: solid black;">
        <center>
        <?php $tr = mysqli_fetch_assoc($rows);?>
            <h4><?php echo $tr["Nama_guru"];?></h4>
            <h5><?php echo $tr['NIK'];?></h5>
        </center>
        ...
        <div class="data">
            <form>
                <div class="form-group">
                    ...
                    <input type="email" class="form-control mb-2" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="<?php echo $tr['NIK'];?>" readonly>
                </div>
                <div class="form-group">
                    <label for="Nama">Nama Lengkap</label>
                    <input type="email" class="form-control mb-2" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="<?php echo $tr['Nama_guru'];?>" readonly>
                </div>
                <div class="form-group">
                    <label for="Nama">Tanggal Lahir</label> <br>
                    <input type="text" class="form-control mb-2" id="tgl-lahir" name="Tanggal Lahir" placeholder="<?php echo $tr['Tanggal_lahir'];?>"readonly>
                </div>
                <div class="form-group">
                    <label for="Nama">Alamat</label>
                    <textarea class="form-control mb-2" id="exampleFormControlTextarea1" rows="3" readonly><?php echo $tr['Alamat'];?></textarea>
                </div>
                <div class="form-group">
