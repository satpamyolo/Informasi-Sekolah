...
<div class="container">
    <div class="row">
        ...
        <div class="card login-form">
            <div class="card-header">
                <h2 class="card-title text-primary">Login Siswa</h2>
            ...
            <div class="card-body">
              <form action="" method="post" role="form">
                ...
                <div class="mb-4">
                  ...
                  <input type="text" class="form-control" name="fusername" placeholder="Your NIS">
                </div>
                <div class="mb-3">
                  <label for="exampleInputPassword1" class="form-label">Password*</label>
                  <input type="password" class="form-control" name="fpassword" placeholder="Min 8 character">
                </div>
    ...
    <?php 
        if (isset($_POST['fmasuk'])) {
            ...
            $qry = mysqli_query($koneksi, "SELECT * FROM login_siswa WHERE NIS = '$username' AND password = '$password'");
            $cek = mysqli_num_rows($qry);
            if ($cek==1){
                $_SESSION['userweb']=$username;
                echo '<script language = "Javascript">
                alert("Anda berhasil login!"); document.location="profil_siswa.php";</script>';
            } else {
                echo '<script language = "Javascript">
                alert("Username dan Password Salah! Silahkan Login Kembali."); document.location="LoginSiswa.php";</script>';
            }
        }
    ?>
     <!-- Footer -->
