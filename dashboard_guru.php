    ...
    <div class="container p-5 my-5">
        <div class="row" style="padding-bottom: 50px;">
            ...
            <?php $tr = mysqli_fetch_assoc($rows);?>
                <h3 style="font-weight:bold"><?php echo $tr["Nama_guru"]; ?></h3>
                <h5 style="color: black;"><?php echo $tr["NIK"]; ?></h5>
            </center>
        </div>

        <center>
            <div class="content-profil">
                <h5 style="padding: 20px; color: black; border-bottom: solid black;">Informasi Guru</h5>
                <div class="row" style="padding: 30px;">
                    <div class="col">
                        <button class="container p-3 rounded-2">
                            <a href="data-diri-guru.php" style="color:black">Data Diri</a>
                        </button>
                    </div>
                    <div class="col">
                        <button class="container p-3 rounded-2">
                            <a href="#" style="color:black">Input Nilai</a>
                        </button>
                    </div>
                    <div class="col">
                        <button class="container p-3 rounded-2">
                            <a href="kelola_akun_guru.php" style="color:black">Kelola akun</a>
                        </button>
                    </div>
                </div>
                ...
                <div class="row" style="padding: 20px">
                    ...
                    <div class="col">
                        <button class="container p-3 rounded-2">
                            <a href="jurnal.php" style="color:black">Upload Jurnal</a>
                        </button>
                    </div>
                </div>
                <div class="row" style="padding: 20px">
                    <div class="col">
                        <button class="container p-3 rounded-2">
                            <a href="databerita.php" style="color:black">Upload Berita</a>
                        </button>
                    </div>
                    <div class="col">
                        <button class="container p-3 rounded-2">
                            <a href="datapeng.php" style="color:black">Upload Pengumuman</a>
                        </button>
                    </div>
                    <div class="col">
                        <button class="container p-3 rounded-2">
