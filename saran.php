...
<head>
    ...
    <title>Saran_SMA N 8 Kota Ternate</title>
...
<body style="background-image: url(sarangmb1.png);">
  ...
  <section>
      <div class="container p-5 mb-5 my-5" style="background-color: rgba(63, 63, 63, 0.434);" data-aos="fade-up">
          <!--Section: Contact v.2-->
          <section class="mb-4">

              <!--Section heading-->
              <h2 class="h1-responsive font-weight-bold text-center my-4" id="kritik">Kritik & Saran</h2>
              <!--Section description-->
                        ...
                        <form id="contact-form" name="contact-form" action="https://formspree.io/f/xjvdnjbv" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="md-form mb-0">
                                        <label for="name" class="lab"><b>Nama Anda</b></label>
                                ...
                                <div class="col-md-6">
                                    <div class="md-form mb-0">
                                        <label for="email" class="lab">Email Anda</label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12" style="padding-bottom: 10px;">
                                    ...
                                    <div class="md-form">
                                        <label for="message" class="lab">Pesan</label>
