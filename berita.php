...
<body>
    ...
    <!--Container-->
    <judul style = "font-family: Didot; text-align: center; margin-top: 15px;">
    <h1 style= "font-size: 50px; font-weight: bold; margin-top: 30px">Warta Sekolah</h1>
    <p>Selamat datang di halaman berita sekolah</p>
    </judul>
            ...
            if ($jmlArtikel > 0) {
              while ($row = mysqli_fetch_assoc($hasil)) {
                  ...
                  <div class="box" style="border-radius: 20px;">
                      <div class="image" style="border-top-left-radius: 20px; border-top-right-radius: 20px;">
                          <img src="imgberita/<?= $row["foto"]; ?>" alt="">
                      </div>
                      <div class="content">
                          <h2><a href="beritadetail.php?idberita=<?= $row["idberita"]; ?>"><?= $row["judul"]; ?></a></h2>
                      </div>
                  </div>
                  <?php
              }
