...
<body style="background-image: linear-gradient(#e6e6e6,#ffffff)">
   ...
   <header>
    ...
    <div class="masterhead" style="background-image: url(https://www.phpsd.com/hs-fs/hubfs/Php_Sd_images/sub-bg-school-2.jpg?width=1600&name=sub-bg-school-2.jpg);height: 300px;">
        <div class="d-flex justify-content-center align-items-end">
           <img style="height: 200px;" src="" alt="">
        </div>
    <!-- Container -->
    <div class="container"><h2 style="font-style: italic;" class="text-light"><b>Mengapa SMAN 8 Kota Ternate</b></h2></div>
    <div class="container p-3 my-5 bg-light text-dark rounded-4 border border-top-primary-2"> <br>
        <div class="text-center">
            <div class="row align-items-center">
                <div class="col">
                        <img style="width: 50px;" src="logo/Group 134.png" class="card-img-top" alt="...">
                        <div class="card-body"> <br>
                          <h2 style="color: #0171BB;" class="card-title">A</h2> <br>
                          <p class="card-text text-muted">Akreditasi Unggul dari Kemendikbud </p> <br>
                        </div>
                </div>
                <div class="col">
                         <img style="width: 50px;" src="logo/Group 135.png" class="card-img-top" alt="...">
                        <div class="card-body"> <br>
                          <h2 style="color: #0171BB;" class="card-title">1.000+</h2> <br>
                          <p class="card-text text-muted">Lulusan Terbaik SMAN 8 Kota Ternate</p> <br>
                        </div>
                </div>
                <div class="col">
                    <img style="width: 50px;" src="logo/Group 136.png" class="card-img-top" alt="...">
                    <div class="card-body"> <br>
                      <h2 style="color: #0171BB;" class="card-title">2013 Merdeka</h2> <br>
                      <p class="card-text text-muted">Kurikulum 2013 dan Kurikulum Merdeka</p> <br>
                    </div>
                </div>
                <div class="col">
                    <img style="width: 50px;" src="logo/Group 137.png" class="card-img-top" alt="...">
                    <div class="card-body"> <br>
                      <h2 style="color: #0171BB;" class="card-title">7Ha</h2> <br>
                      <p class="card-text text-muted">Lingkungan Belajar Luas dan Lengkap</p> <br>
                    </div>
                  </div>
              </div>
        </div>
    ...
    <div style="background-color: #0171BB; font-style: italic; color: #dedddd; padding: 50px" class="container-fluid" data-aos="fade-left">
      <div class="container">
        <h3 class="text-center">Prestasi SMAN 8 Kota Ternate</h3> <br>
        <div class="row g-0">
          <div class="col-md-9">
              <p style="width: 700px;">Komitmen SMAN 8 Kota Ternate menjadi dasar pengembangan karakter para peserta didik. Senantiasa memberikan pendidikan 
                yang terbaik untuk lintas generasi, menjadikan SMAN 8 Kota Ternate sekolah swasta terbaik di Maluku.
                </p>
                <p style="width: 700px;">Komitmen SMAN 8 Kota Ternate menjadi dasar pengembangan karakter para peserta didik. Senantiasa memberikan pendidikan 
                  yang terbaik untuk lintas generasi, menjadikan SMAN 8 Kota Ternate sekolah swasta terbaik di Maluku.
                  </p><br>
                <a href="prestasi.php" onclick="" style="color: #0171BB;" class="btn btn-light">Lihat Selengkapnya</a>
          </div>
          <div class="col-md-2">
            <div class="card" style="width: 18rem;">
              <div class="card-body">
                <h5 class="card-title">Moto</h5>
                <p class="card-text">"Terciptanya Generasi yang Unggul dalam Ilmu, Iman, Amal,berkarakter dan Menguasai Teknologi"</p>
                <p class="card-text">SMAN 8 Kota Ternate</p>
              </div>
            </div>
          </div>
        </div>
