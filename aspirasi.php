...
<body style="background-color: #CAF3FC;">
   ...
   <header>
    ...
    <div class="container p-5 bg-light text-dark rounded-5" style="box-shadow:  2px 2px 2px rgba(0,0,0,0.8); padding-left: 10px; padding-right: 10px;">
    <center>
    <h1 class="mb-5">ASPIRASI</h1>
    </center>
        <div class="d-flex">
          <div class="container-sm mx-4" style="width: 360px;">
            <div class="py-5 my-4 bg text-center">
              <img src="pict/jas-csl.png.png" alt="Event Image" style="width: 200px;">
            </div>
          </div>
          <div class="ml-3">
            <h4 class="mb-3">Hallo teman-teman! Namaku Aspira.</h4>
            <p>Gimana kabarmu, baik baik saja?</p>
            <br>
            <p>Aku di sini akan menyampaikan tugasku, yaitu mendengar aspirasimu untuk sekolah kita, SMAN 8 Ternate!</p>
            <br>
            <p>Sebagai siswa SMAN 8 Ternate bebas mengutarakan aspirasimu. Ini untuk kita, untukku dan untukmu. Kita di sini sebagai murid saling menjaga nama sekolah, membanggakan, dan menginspirasi. Maka dari itu katakanlah aspirasimu, katakanlah pendapatmu, semua ini untuk memajukan SMAN 8 Ternate!
              Teman-teman, intinya ini adalah kesempatan, mari bantu aku dengan aspirasimu, bantu dengan keluh saranmu untuk memajukan sekolah ini!
              Ada sedikit aturan untuk pengisian Aspirasi nih teman! Aspirasi bisa diisi sekurang-kurangnya 3 bulan sekali, kemudian untuk pengisiannya bisa bersifat individual dan bisa juga secara kolektif (satu kelas).
              Pengisian Aspirasi secara individual tidak diwajibkan ya teman, bisa disesuaikan keperluan masing-masing!
              Akan tetapi pengisian secara kolektif setiap kelas diwajibkan setiap 3 bulan sekali sebagai representasi dari pendapat teman teman semua!.</p>
          </div>
        </div>
        <div class="container button" style="display: flex; justify-content: center; align-items: center; height: 10vh;">
          <a class="button" href="saran.php" style="display: inline-block; padding: 12px 24px; background-color: #4CAF50; color: white; text-decoration: none; font-size: 18px; border-radius: 4px; transition: transform 0.3s ease;">Masukkan Aspirasi</a>
        </div>
      </div>
    </div>
