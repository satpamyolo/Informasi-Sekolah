...
<header>
    ...
    <!-- Container -->
    <div class="container p-5 my-5 bg-light text-dark rounded-3 padding: 10px;">
        <div style="position: relative;">
            <h2 style="color: #0171B B;">Visi dan Misi</h2><br>
            <h4 style="color: #0171BB;">Visi :</h4>
            <p>“Terciptanya generasi yang unggul dalam
                ilmu, iman, amal, berkarakter dan menguasai
                teknologi"</p>
            <h4 style="color: #0171BB;">Misi :</h4>
            <p style="width: 950px;">Untuk mencapai visi dan membentuk karakter Profil Pelajar Pancasila,
                maka SMA Negeri 8 Kota Ternate menetapkan misi sebagai berikut :
                <ol type="1" style="width: 800px;">
                    <li>Membentuk pribadi murid yang beriman dan bertaqwa kepada Tuhan Yang Maha Esa</li>
                    <li>Meningkatkan pembelajaran yang berorientasi pada pengembangan pendidikan yang
                        berkualitas serta memiliki integritas kepribadian yang tangguh.</li>
                    <li>Mengembangkan minat dan bakat murid melalui intrakurikuler dan ekstrakurikuler sesuai
                        karakteristik dan potensi yang dimiliki.</li>
                    <li>Menciptakan lingkungan belajar yang menyenangkan, kritis, kreatif, komunikatif dan kolaboratif.</li>
                    <li>Menghasilkan lulusan yang berkualitas tinggi dalam perkembangan intelektualnya
                        dan mempunyai karakter taqwa, jujur, kreatif, mampu menjadi teladan, bekerja
                        keras, toleran, dan cakap dalam memimpin.</li>
                    <li>Menjawab tantangan akan kebutuhan pengembangan sumber daya manusia dan berperan
                        dalam perkembangan ilmu pengetahuan dan teknologi.</li>
                </ol></p>
         </div>
        </div>
    </div>
