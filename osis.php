...
session_start();
include 'koneksi.php';
$query = "SELECT*FROM osis where jabatan='ketua'";
$rows = mysqli_query($koneksi, $query);
$query1 = "SELECT*FROM osis where jabatan='wakil ketua'";
$rows1 = mysqli_query($koneksi, $query1);
$query2 = "SELECT*FROM osis where jabatan= 'bendahara_1'";
$rows2 = mysqli_query($koneksi, $query2);
$query3 = "SELECT*FROM osis where jabatan= 'bendahara_2'";
$rows3 = mysqli_query($koneksi, $query3);
$query4 = "SELECT*FROM osis where jabatan= 'sekretaris_1'";
$rows4 = mysqli_query($koneksi, $query4);
$query5 = "SELECT*FROM osis where jabatan= 'sekretaris_2'";
$rows5 = mysqli_query($koneksi, $query5);
?>
...
<head>
    ...
    <title>osis_SMA N 8 Kota Ternate</title>
...
<body>
    ...
    <!-- Container -->
    <div class="masterhead" style="background-image: url(osis1.jpg);height: 640px; mask-repeat: no-repeat;">
      <div class="colour-overlay d-flex justify-content-center align-items-center">
          <div class="text-white">
              <h2 style="color: white;"><b>OSIS</b></h2><br>
              <h2 style="color: white;"><b>SMAN 8 TERNATE</b></h2><br>
          </div>
      </div>
</div>
    ...
    <div class="container-md mt-5 mb-5">
        <div class="row">
          <div class="col-md text-center">
            <h1 style="color: #0171BB;">PENGURUS OSIS</h1>
            
          </div>
        </div>
  
        <div class="row p-2 ml-5 text-center md">
          <div class="col py-3">
            <div class="card" style="width: 18rem; height: 25rem">
              <div class="card-body p-5 text-white bg-body-secondary">
                <img src="Ellipse 3.png" width="150" >
               <p></p>
               <p class="fs-4", style="color: #666;"><?php $tr = mysqli_fetch_assoc($rows); echo $tr['nama'] ?></p>
                <p class="card-text">
                    <b class="fs-2" style="color:#15305B">Ketua Osis</b>
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="col py-3 ">
            <div class="card" style="width: 18rem; height: 25rem">
              <div class="card-body p-5 text-white bg-body-secondary">
                <img src="Ellipse 4.png" width="150" >
               <p></p>
               <p class="fs-4", style="color: #666;"><?php $tr1 = mysqli_fetch_assoc($rows1); echo $tr1['nama'] ?></p>
                <p class="card-text">
                    <b class="fs-2" style="color:#15305B">Wakil Ketua Osis</b>
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="col py-3 ">
            <div class="card" style="width: 18rem; height: 25rem">
              <div class="card-body p-5 text-white bg-body-secondary">
                <img src="Ellipse 5.png" width="150" >
               <p></p>
               <p class="fs-4", style="color: #666;"><?php $tr2 = mysqli_fetch_assoc($rows2); echo $tr2['nama'] ?> </p>
                <p class="card-text">
                    <h7 class="fs-2" style="color:#15305B;">Bendahara 1</h7>
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="row p-2 ml-5 text-center md">
            <div class="col py-3">
              <div class="card" style="width: 18rem; height: 25rem">
                <div class="card-body p-5 text-white bg-body-secondary">
                  <img src="Ellipse 6.png" width="150" >
                 <p></p>
                 <h6 class="fs-4", style="color: #666;"><?php $tr3 = mysqli_fetch_assoc($rows3); echo $tr3['nama'] ?></h6>
                  <p class="card-text">
                      <h7 class="fs-2" style="color:#15305B">Bendahara 2</h7>
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="col py-3">
              <div class="card" style="width: 18rem; height: 25rem">
                <div class="card-body p-5 text-white bg-body-secondary">
                  <img src="Ellipse 10.png" width="150" >
                 <p></p>
                 <p class="fs-4", style="color: #666;"><?php $tr4 = mysqli_fetch_assoc($rows4); echo $tr4['nama'] ?></p>
                  <p class="card-text">
                      <b class="fs-2" style="color:#15305B">Sekretaris 1</b>
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="col py-3 ">
              <div class="card" style="width: 18rem; height: 25rem">
                <div class="card-body p-5 text-white bg-body-secondary">
                  <img src="Ellipse 7.png" width="150" >
                 <p></p>
                 <p class="fs-4", style="color: #666;"><?php $tr5 = mysqli_fetch_assoc($rows5); echo $tr5['nama'] ?></p>
                  <p class="card-text">
                      <b class="fs-2" style="color:#15305B">Sekretaris 2</b>
                  </p>
                </div>
              </div>
            </div>
