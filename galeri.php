    ...
    <div id="carouselExampleCaptions" class="carousel slide mb-3" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
              <div class="masterhead" style="background-image: url(https://www.smadwiwarna.sch.id/wp-content/uploads/2018/03/Pelajari-Kebiasaan-Pelajar-Sukses.jpg);height: 600px; mask-repeat: no-repeat;">
                <div class="colour-overlay d-flex justify-content-center align-items-center">
                    <div class="text-white">
                        <h2 class="mb-3"><b>Kegiatan Pembelajaran</b></h2>
                        <h6 class="mb-3">Foto mengenai kegiatan pembelajaran di sekolah</h6>
                        <a class="btn btn-outline-light btn-lg" href="galeridetail.php" role="button">Jelajahi</a>
                    </div>
                </div>
              </div>
            ...
            <div class="carousel-item">
              <div class="masterhead" style="background-image: url(https://as1.ftcdn.net/v2/jpg/02/49/55/26/1000_F_249552639_BNVLeVSKrxONSRmEl0qdFCWk7RdVPf9R.jpg);height: 640px; mask-repeat: no-repeat;">
                <div class="colour-overlay d-flex justify-content-center align-items-center">
                    <div class="text-white">
                        <h2 class="mb-3"><b>Event Sekolah</b></h2>
                        <h6 class="mb-3">Kegiatan sekolah selain pembelajaran</h6>
                        <a class="btn btn-outline-light btn-lg" href="galeridetail.php" role="button">Jelajahi</a>
                    </div>
                </div>
              </div>
            ...
            <div class="carousel-item">
              <div class="masterhead" style="background-image: url(https://static.republika.co.id/uploads/member/images/news/qn0fpv9efm.jpg);height: 640px; mask-repeat: no-repeat;">
                <div class="colour-overlay d-flex justify-content-center align-items-center">
                    <div class="text-white">
                        <h2 class="mb-3"><b>Galeri Sekolah</b></h2>
                        <h6 class="mb-3">Foto bangunan sekolah</h6>
                        <a class="btn btn-outline-light btn-lg" href="galeridetail.php" role="button">Jelajahi</a>
                    </div>
                </div>
              </div>
