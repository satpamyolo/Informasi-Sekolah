...
<head>
    ...
    .prestasi-content .box-container {
    display: grid;
    grid-template-columns: repeat(auto-fit, minmax(30rem, 1fr));
    gap: 3rem;
    }

    .prestasi-content .box-container .box{
    /* border: var(--border); */
    box-shadow: var(--box-shadow);
    background: var(--white);
    }

    .prestasi-content .box-container .btn{
    ...
    .prestasi-content .box-container .btn:hover{
    background: blue;
    }

    .prestasi-content .box-container .image{
    height: 25rem;
    overflow: hidden;
    }

    .prestasi-content .box-container .image img{
    height: 100%;
    width: 100%;
    object-fit: cover;
    ...
    .prestasi-content .box-container .image img:hover{
    scale:1.1;
    }

    .prestasi-content .box-container .content{
    padding: 2rem;
    text-align: center;
    }

    .prestasi-content .box-container .content h3{
    font-size: 16px;
    }

    .prestasi-content .box-container .content p{
    padding: .8rem;
    font-size: 14px;
    ...
    .prestasi-content .heading-title, .home-atractive .heading-title {
    text-align: center;
    margin-bottom: 3rem;
    ...
    .prestasi-content .load-more{
    text-align: center;
    margin-top: 3rem;
    }

    .prestasi-content .box-container .btn-see{
    margin-right: 12rem;
    color: black;
    font-size: 14px;
    ...
    .prestasi-content .box-container .btn-see:hover{
    color: purple;
    }

    :root{
    --main-color: rgb(61, 78, 159);
    --black:#222;
    --white:#fff;
    --blue:blue;
    --light-black:#777;
...
<body>
    ...
    <!--Container-->
    <div class="headprestasi" style="background-image: url(https://assets-a1.kompasiana.com/items/album/2022/06/20/gambar-gedung-sekolah-modern-18-62b092d4383500028971a2d3.jpg);height: 500px;">
        <div class="d-flex justify-content-center align-items-end">
           <img style="height: 200px;" src="" alt="">
        </div>
        <div class="container"><h2 class="text-light" style="text-align: center; font-size: 40px; padding-top: 40px;"><b>Prestasi</b></h2></div>
    </div>
    <div class="content" style="display: flex; padding: 5px;"></div>
