...
<body>
  ...
  <div class="container">
  <h1 style="text-align: center; padding: 80px;">Kelola Data Galeri</h1>
  <a href="upglr.php" class="btn btn-success">Tambah</a> <br><br>   
        <table class="table">
            <thead>
              <tr>
            ...
            <tbody>
            <?php
					    $selectQuery = "select * from galeri";
					    $squery = mysqli_query($koneksi, $selectQuery);
              $no = 1;
              if(isset($_GET['idgaleri'])){
             
                mysqli_query($koneksi, "delete from galeri where idgaleri='$_GET[idgaleri]'");
                echo "Data Terhapus";
                echo '<script language = "Javascript">document.location="dataglr.php";</script>';
				    ...
				    ?>
				        ...
				        <td><a href='?idgaleri=<?php echo $result['idgaleri']?>' onclick="return confirm('Yakin hapus data?')" class="btn btn-danger">Hapus</a></td>
				        </tr>
