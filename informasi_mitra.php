...
<body>
   ...
   <header>
    ...
    <div class="container p-3 my-3">
        <h4 style="color: orange; padding-bottom: 10px; width: 20%; font-weight: bold;">Informasi Mitra</h4>
        <div class="mitra">
            <div class="container p-3">
                <h5>Google</h5>
                <img src="google.jpeg" alt="google-img">
                <p>Google LLC adalah sebuah perusahaan multinasional Amerika Serikat yang berkekhususan pada jasa dan produk Internet. Produk-produk tersebut meliputi teknologi pencarian, komputasi web, perangkat lunak, dan periklanan daring. </p>
                <h5>Freeport</h5>
                <img src="freeport.jpeg" alt="freeport-img">
                <p>sebuah perusahaan Indonesia yang bergerak di bidang eksplorasi, pertambangan, pemprosesan, dan pemasaran konsentrat tembaga, emas, dan perak di dataran tinggi Tembagapura, Mimika, Papua Tengah. </p>
                <h5>Krakatau Steel</h5>
                <img src="krakatau.jpeg" alt="krakatau-img">
                <p>BUMN yang bergerak di bidang produksi baja. Perusahaan yang beroperasi di Cilegon, Banten ini mulanya dibentuk sebagai wujud pelaksanaan Proyek Baja Trikora.</p>
            </div>
        </div>
