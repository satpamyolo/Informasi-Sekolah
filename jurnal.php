...
<body>
  ...
  <div class="container">
  <a href="Upload.php" class="btn btn-success">Tambah Jurnal</a> <br><br>   
        <table class="table">
            <thead>
              <tr>
                <th class="table-secondary" scope="col">Kode</th>
                <th class="table-secondary" scope="col">Judul</th>
                <th class="table-secondary" scope="col">Keterangan</th>
            ...
            <?php
              ...
              if(isset($_GET['ID'])){
                ...
                echo "Data Terhapus";
                echo '<script language = "Javascript">document.location="jurnal.php";</script>';
