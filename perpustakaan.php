...
<header>
    ...
    <!-- Container -->
    <div class="container p-3 my-5" style="background-image: linear-gradient(blue, magenta);">
      <div class="perpus">
        <center>
          <h3>Informasi Perpustakaan Sekolah</h3>
        </center>
        <h5>Peraturan Umum</h5>
        <ol>
          ...
          <li>Tidak diperkenankan menyimpan uang, perhiasan, dan barang-barang berharga lainnya dalam perlengkapan barang yang di titipkan.</li>
        ...
        <ol>
          ...
          <li>Tidak diperkenankan menggunakan haknya sebagai anggota perpustakaan untuk sementara waktu</li>
          <li>Dicabut tanda keanggotaanya dari perpustakaan</li>
        </ol>
      </div>
