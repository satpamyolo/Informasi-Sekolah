...
<body style="background-image: linear-gradient(#ffffff,#294A70)">
   ...
   <header>
    ...
    <!-- Container -->
    <div class="container p-5 my-5 bg-light text-dark rounded-5" style="box-shadow:  2px 2px 2px rgba(0,0,0,0.8); padding: 10px;">
        <center>
            <h2>Pendaftaran Online PPDB SMAN 8 Ternate</h2>
        </center>
        <ul style="padding-top: 30px;">
            <li><b>Syarat Pendaftaran PPDB</b> <br>
                <ol> 
                    <li>Calon peserta didik telah lulus SMP, SMP Terbuka, atau Mts</li>
                    <li>Memiliki ijazah dan STL/STK atau Surat Keterangan Lulus dari sekolah untuk lulusan pada tahun pelajaran baru</li>
                    <li>Memiliki nilai rapor dari semester 1 sampai 5</li>
                    <li>Bagi calon peserta didik dengan Program Paket B, memiliki ijazah dan STL yang lulus pada tahun pelajaran baru</li>
                    <li>Usia calon peserta didik maksimal 21 tahun pada bulan penerimaan ppdb</li>
                    <li>Menyertakan Kartu Keluarga yang diterbitkan minimal 1 tahun sebelum pendaftaran PPDB.</li>
                    <br>
                </ol>
            </li>
            <li>
                <b>Jalur Pendaftaran PPDB</b> <br>
                <ol>
                    <li>Jalur Zonasi</li>
                    <li>Jalur Afirmasi</li>
                    <li>Jalur Perpindahan Orang Tua</li>
                    <li>Jalur Prestasi</li>
                </ol>
            </li> <br>
            <li>
                <b>Alur Pendaftaran PPDB</b> <br>
                <ol>
                    <li>Tahap pendaftaran PPDB jenjang SMA yang harus dilalui calon peserta didik baru adalah: Pendaftaran online PPDB</li>
                    <li>Verifikasi Pendaftaran</li>
                    <li>Pengumuman Hasil Tahap 1</li>
                    <li>Seleksi</li>
                    <li>Pengumuman Hasil Akhir</li>
                    <li>Daftar Ulang</li>
                </ol>
            </li> <br>
            <li>
                <b>PENDAFTARAN DAN MEKANISME SELEKSI</b> <br>
                <ol>
                    <li>Calon peserta didik baru menyiapkan berkas pendaftaran yang dipersyaratkan</li>
                    <li>Calon peserta didik baru mengakses laman situs PPDB Online yang telah ditunjuk pemerintah</li>
                    <li>Calon peserta didik mengajukan pendaftaran secara mandiri dengan mengisi formulir dan biodata diri secara online maupun offline dengan tetap memperhatikan prosedur dan protokol COVID 19</li>
                    <li>Calon peserta didik mengunggah dokumen persyaratan sesuai dengan jalur pendaftaran yang dipilih dan ketentuan yang diminta</li>
                    <li>Calon peserta didik memilih sekolah tujuan dengan mengutamakan tempat tinggal dalam zona yang sama dengan sekolah tujuan</li>
                    <li>Setelah memastikan seluruh data yang dimasukkan lengkap dan benar, calon peserta didik dapat menyimpan datanya dan mencetak bukti pengajuan pendaftaran</li>
                    <li>Berkas akan diverifikasi oleh operator secata online</li>
                    <li>Hasil seleksi dapat dilihat secara online di laman situs yang sama.</li>
                </ol>
            </li> <br>
            <li>
                <b>PENGUMUMAN DAN PENDAFTARAN ULANG</b> <br>
                <ol>
                    <li>Pengumuman hasil seleksi PPDB akan diumumkan secara terbuka melalui laman situs resmi PPDB</li>
                    <li>Peserta didik yang dinyatakan diterima wajib melakukan daftar ulang dengan mengisi form yang tersedia di portal resmi sekolah tujuan</li>
                    <li>Apabila peserta didik yang diterima tidak melakukan daftar ulang sesuai jadwal yang ditentukan maka dinyatakan mengundurkan diri</li>
                    <li>Apabila pada peserta didik baru yang sudah diterima ditemukan adanya kondisi yang tidak sesuai dengan ketentuan pada Petunjuk Teknis PPDB maka peserta didik dinyatakan gugur</li>
                </ol>
            </li>
        </ul>
