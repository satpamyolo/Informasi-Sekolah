...
<header>
    ...
    <div class="">
        <div class="container p-2  my-5">
            <h5 style="border-bottom: solid #0171BB; padding-bottom: 10px; width: 15%;">Informasi SDM</h5>
            <div class="container">
                <div class="row justify-content-md-center text-center">
                    <div class="col-sm-3 py-5">
                        <img src="<?php $kepala = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT*From guru where jabatan = 'kepala'"));echo $kepala["foto"]; ?>" class="rounded-circle" alt="Foto Kepsek" width="100px" height="100px">
                        <h6 style="padding: 5px;">Kepala Sekolah</h6>
                        <?php echo $kepala["Nama_guru"]; ?>
                    </div>
                </div>
                <div class="row text-center">
                    <div class="col-sm-3 p-3">
                        <img src="<?php $kepala = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT*From guru where jabatan = 'tu'")); echo $kepala["foto"];?>" class="rounded-circle" alt="Foto Kepsek" width="100px" height="100px">
                        <h6 style="padding: 5px;">Kepala Tata Usaha</h6>
                        <?php echo $kepala["Nama_guru"]; ?>
                    </div>

                    <div class="col-sm-3 p-3">
                        <img src="<?php $kepala = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT*From guru where jabatan = 'kurikulum'")); echo $kepala["foto"];?>" class="rounded-circle" alt="Foto Kepsek" width="100px" height="100px">
                        <h6 style="padding: 5px;">Wakil Kurikulum</h6>
                        <?php echo $kepala["Nama_guru"]; ?>
                    </div>

                    <div class="col-sm-3 p-3">
                        <img src="<?php $kepala = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT*From guru where jabatan = 'kesiswaan'")); echo $kepala["foto"];?>" class="rounded-circle" alt="Foto Kepsek" width="100px" height="100px">
                        <h6 style="padding: 5px;">Wakil Kesiswaan</h6>
                        <?php echo $kepala["Nama_guru"]; ?>
                    </div>

                    <div class="col-sm-3 p-3">
                        <img src="<?php $kepala = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT*From guru where jabatan = 'osis'")); echo $kepala["foto"];?>" class="rounded-circle" alt="Foto Kepsek" width="100px" height="100px">
                        <h6 style="padding: 5px ;">Pembina Osis</h6>
                        <?php echo $kepala["Nama_guru"]; ?>
                    </div>
                </div>
            </div>
    ...
    <div class="container p-3 my-3 bg-light text-dark rounded-3 mb-5" style="box-shadow:  2px 2px 2px rgba(0,0,0,0.8); padding: 10px;">
        <center>
            <h6 style="border-bottom: solid #0171BB; padding-bottom: 10px; width: 15%;">Daftar Guru</h6>
        </center>
        <br>
        <div class="row" style="padding-top: 20px;">
            <div class="col">
                <div class="container text-center rounded-3" style="box-shadow:  2px 2px 2px rgba(0,0,0,0.8); padding: 10px;">
                    Bahasa Indonesia
                </div>

                <?php
                $tampil = mysqli_query($koneksi, "SELECT*FROM guru WHERE jabatan ='bindo'");
                $no = 1;
                while ($hasil = mysqli_fetch_array($tampil)) {
                ?>
                    <ul style="padding-top: 10px;">
                        <li><?php echo $hasil['Nama_guru']; ?></li>
                    </ul>
                <?php
                    $no++;
                }
            ...
            <div class="col">
                ...
                <?php
                $tampil = mysqli_query($koneksi, "SELECT*FROM guru WHERE jabatan ='mtk'");
                $no = 1;
                while ($hasil = mysqli_fetch_array($tampil)) {
                ?>
                    <ul style="padding-top: 10px;">
            ...
            <div class="col">
                ...
                <?php
                $tampil = mysqli_query($koneksi, "SELECT*FROM guru WHERE jabatan ='fisika'");
                $no = 1;
                while ($hasil = mysqli_fetch_array($tampil)) {
                ?>
                    <ul style="padding-top: 10px;">
            ...
            <div class="col-sm-3">
                ...
                <?php
                $tampil = mysqli_query($koneksi, "SELECT*FROM guru WHERE jabatan ='kimia'");
                $no = 1;
                while ($hasil = mysqli_fetch_array($tampil)) {
                ?>
                    <ul style="padding-top: 10px;">
        ...
        <div class="row" style="padding-top: 20px;">
            <div class="col-sm-3">
                ...
                <?php
                $tampil = mysqli_query($koneksi, "SELECT*FROM guru WHERE jabatan ='penjas'");
                $no = 1;
                while ($hasil = mysqli_fetch_array($tampil)) {
                ?>
                    <ul style="padding-top: 10px;">
            ...
            <div class="col-sm-3">
                ...
                <?php
                $tampil = mysqli_query($koneksi, "SELECT*FROM guru WHERE jabatan ='inggris'");
                $no = 1;
                while ($hasil = mysqli_fetch_array($tampil)) {
                ?>
                    <ul style="padding-top: 10px;">
            ...
            <div class="col-sm-3">
                ...
                <?php
                $tampil = mysqli_query($koneksi, "SELECT*FROM guru WHERE jabatan ='pkn'");
                $no = 1;
                while ($hasil = mysqli_fetch_array($tampil)) {
                ?>
                    <ul style="padding-top: 10px;">
            ...
            <div class="col-sm-3">
                ...
                <?php
                $tampil = mysqli_query($koneksi, "SELECT*FROM guru WHERE jabatan ='agama'");
                $no = 1;
                while ($hasil = mysqli_fetch_array($tampil)) {
                ?>
                    <ul style="padding-top: 10px;">
