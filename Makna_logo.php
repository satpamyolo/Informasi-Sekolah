...
<body style="background-image: linear-gradient(white,#294A70)">
    ...
    <div class="container p-5 my-5 bg-light text-dark rounded-5" style="box-shadow:  2px 2px 2px rgba(0,0,0,0.8); padding: 10px;">
        <center>
            <img src="logo.png" alt="logosekolah" >
            <h4>Makna Logo SMAN 8 Kota Ternate</h4>
        </center>
        <ol class="ordered" style="padding-top: 30px;">
            <li><b>BIDANG SEGI LIMA</b> : Bermakna menjunung tinggi Pancasila sebagai falsafah dan pandangan hidup bangsa Indonesia.</li>
            <li><b>PENA dan BUKU </b> : Bermakna bahwa SMA Negeri 8 Kota Ternate merupakan sumber ilmu dan pengetahuan.</li>
            <li><b>BINTANG</b> : Bintang bermakna prestasi, keberhasilan, dan keunggulan. </li>
            <li><b>CENGKEH</b> : Menggambarkan nilai-nilai tradisional, kekayaan budaya</li>
            <li><b>KAPAS</b> : Bermakna keindahan, keanggunan, dan kelembutan</li>
            <li><b>Warna</b> : 
                <ul>
                    <li><b>Merah</b> Melambanglkan Bermakna tekad dan keberanian yang tinggi dan pantang menyerah.</li>
                    <li><b>Biru</b> Melambangkan hubungan profesionalitas, percaya diri, kecerdasan dan simbol kekuatan.</li>
                </ul>
            </li>
        </ol>
    </div>
